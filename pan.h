...
#define SpinVersion	"Spin Version 6.4.4 -- 1 November 2015"
#define PanSource	"BA.prm"
...
#define nstates3	11	/* p2 */
#define minseq3	305
#define maxseq3	314
#define endstate3	10

#define nstates2	103	/* :init: */
#define minseq2	203
#define maxseq2	304
#define endstate2	102

#define nstates1	132	/* main */
#define minseq1	72
#define maxseq1	202
#define endstate1	131

#define nstates0	73	/* equip */
#define minseq0	0
#define maxseq0	71
#define endstate0	72
...
typedef struct P1 { /* main */
	...
	int temp;
	int answer;
	int commonEventTable[4];
} P1;
#define Air1	(sizeof(P1) - Offsetof(P1, commonEventTable) - 4*sizeof(int))

#define Pequip	((P0 *)this)
typedef struct P0 { /* equip */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, AD) - 1*sizeof(int))
...
#define HAS_TRACK	0
/* hidden variable: */	int endedEquip;
